...
| **OPD-09** | Split payment | **Remove** the `split` method from code and schema. Drop `split_payment_method_1/2`, `split_payment_amount_1/2`. Multi-method scenarios handled manually by admin. | ⏭ Wave B / Wave E |
